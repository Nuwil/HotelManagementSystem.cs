...
namespace HotelManagementSystem
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            HotelRoom room1 = new HotelRoom(101, RoomStyle.TwinRoom, 1500, true);
            HotelRoom room2 = new HotelRoom(102, RoomStyle.KingRoom, 3000, true);
            ...
            HotelRoom hotel456Room1 = new HotelRoom(101, RoomStyle.QueenRoom, 2000, true);
            HotelRoom hotel456Room2 = new HotelRoom(102, RoomStyle.QueenRoom, 2000, true);
